    <x-layouts.profesores.dashboard notas titulo="Notas">
        ...
        <div class="flex justify-center mb-4">
            <select
                class="block w-1/3 px-4 py-2 text-base text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500">
        ...
        <div class="flex justify-center mb-4">
            <a href="">
                <input type="button" value="Cambiar Periodo"
