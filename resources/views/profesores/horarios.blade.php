    ...
    <tbody>
        @foreach($horarios as $franja => $celdas)
            <tr>
                ...
                @foreach($dias as $clave => $etiqueta)
                    @if(isset($celdas[$clave]) && $celdas[$clave] && $celdas[$clave]['titulo'])
                            ...
                            <div class="horario-card p-2 rounded">
                                ...
                                <div class="small mt-2">
                                    @if(!empty($celdas[$clave]['salon']))
                                        <a href="#" class="text-decoration-none small">{{ $celdas[$clave]['salon'] }}</a>
...
<style>
    .horario-card {
        ...
        min-height: 72px;          /* tarjetas igualadas en altura */
